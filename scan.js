...
/* =====================================================
   ...
   Replaces: Tesseract
   New: Handwriting support, faster, cleaner output
   ===================================================== */
...
async function runOCR(file) {
    ...
    try {
        /* Step 1: Image ko bitmap mein convert karo (fast processing) */
        const imageBitmap = await createImageBitmap(file);

        /* Step 2: MediaPipe Vision setup */
        const vision = await FilesetResolver.forVisionTasks(
            "https://cdn.jsdelivr.net/npm/@mediapipe/tasks-vision@latest/wasm"
        );

        const textRecognizer = await TextRecognizer.createFromOptions(vision, {
            baseOptions: {
        ...
        /* Step 3: ✅ Kachra Sanitizer — OCR garbage clean karo */
        let rawText = result.text || "";
        let cleaned = rawText
            .replace(/[^\w\s\d.,!?@#%&()\-:]/g, '')   /* special garbage hata */
            .replace(/\s+/g, ' ')                        /* extra spaces hata */
            .trim();
...
if (imageInput) {
    imageInput.onchange = function() {
        ...
        html5Qr.scanFile(file, true)
            ...
            .catch(async err => {
                /* QR not found → run upgraded MediaPipe OCR */
                await runOCR(file);
                imageInput.value = "";
            });
    };
...
/* =====================================================
   ...
   New: Unlimited characters, paragraph support, faster
   ===================================================== */
...
if (translateBtn) {
    translateBtn.onclick = async function() {
        ...
        try {
            /* Google GTX Mirror — no key, no char limit */
            const url =
            ...
            if (data && data[0]) {
                /* Unlimited paragraph joiner — saare chunks jodo */
